...
from STOCK_CHOOSE.standard_wave_back import Wave
import pandas as pd
import math


class Initial(Wave):
    def __init__(self, stock_id, num_buy, num_sell, date):
        """
        ...
        Wave.__init__(self, stock_id, date)
...
if __name__ == "__main__":
    ...
    num_selling = 1000
    num_buying = 1000
    obj = Initial(stock, num_buy=num_buying, num_sell=num_selling, date=date)
    s, b = obj.quoting()
    print '挂卖单:\n', s
    print '挂买单:\n', b