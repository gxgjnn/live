...
from vnTrader.eventEngine import Event
from vnTrader.eventType import *
...
from vnTrader.uiBasicWidget import *

import vnTrader.uiBasicWidget as wgs
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, mainEngine, eventEngine, app, sheets):
        ...
        self.app = app
        self.sheets = sheets
        # event2 = Event(type_='vtAccountID')
        # event2.dict_['data'] = df
    ...
    def initCentral(self):
        ...
        # widgetContractM, dockContractM = self.createDock(wgs.AccountMonitor, u'资金', QtCore.Qt.BottomDockWidgetArea)
